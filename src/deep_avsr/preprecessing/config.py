...
root_dir= "/media/xuehuan/multimodal/"

#project structure
args["CODE_DIRECTORY"] = root_dir + "avmultimodal"   #absolute path to the code directory
args["DATA_DIRECTORY"] = root_dir + "data/lrs2mm"   #absolute path to the data directory
...
args["TRAINED_LM_FILE"] = root_dir + "/deep_avsr/audio_visual/language_model.pt"  #absolute path to the trained language model file
args["TRAINED_FRONTEND_FILE"] = root_dir + "/deep_avsr/audio_visual/visual_frontend.pt" #absolute path to the trained visual frontend file
