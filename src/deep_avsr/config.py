...
#project structure
args["CODE_DIRECTORY"] = '/media/xingshuo/home1/multimodal/deep_avsr'   #absolute path to the code directory
args["DATA_DIRECTORY"] = '/media/xingshuo/home1/multimodal/data/lrs2/lrs2_v1/mvlrs_v1/'   #absolute path to the data directory
...
args["TRAINED_LM_FILE"] = "/media/xingshuo/home1/multimodal/deep_avsr/audio_visual/language_model.pt"  #absolute path to the trained language model file
args["TRAINED_FRONTEND_FILE"] = "/media/xingshuo/home1/multimodal/deep_avsr/audio_visual/visual_frontend.pt" #absolute path to the trained visual frontend file
